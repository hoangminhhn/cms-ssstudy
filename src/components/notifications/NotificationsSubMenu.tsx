...
const subMenuItems: SubMenuItem[] = [
  { id: 'all-notifications', label: 'Tất cả thông báo', icon: Bell, path: '/notifications?tab=all-notifications' },
  { id: 'add-notification', label: 'Thêm mới', icon: PlusCircle, path: '/notifications?tab=add-notification' },
];
