...
interface LayoutProps {
  ...
  headerLeftAdornment?: React.ReactNode; // New prop for left adornment in header
}

const Layout: React.FC<LayoutProps> = ({ children, headerTitle, headerLeftAdornment }) => {
  return (
    <div className="min-h-screen w-full overflow-x-hidden lg:grid lg:grid-cols-[280px_1fr]">
      <Sidebar />
      <div className="flex flex-col w-full overflow-x-hidden">
        <Header title={headerTitle} leftAdornment={headerLeftAdornment} /> {/* Pass new props to Header */}
