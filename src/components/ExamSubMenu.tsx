...
import { List, PlusCircle, LayoutGrid, AlertTriangle, Plus, FileText, LayoutTemplate } from 'lucide-react'; // Added LayoutTemplate icon
...
const subMenuItems: SubMenuItem[] = [
  ...
  { id: 'word-exam-upload', label: 'Đề thi file word', icon: FileText, path: '/exams?tab=word-exam-upload' },
  { id: 'question-bank', label: 'Ngân hàng câu hỏi', icon: List, path: '/exams?tab=question-bank' }, // New item
  { id: 'create-template', label: 'Tạo template đề thi', icon: LayoutTemplate, path: '/exams?tab=create-template' }, // New item
