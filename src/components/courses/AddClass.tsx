  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <Card>
        ...
        <CardContent>
          {/* Row 1: Image (left) + primary fields (right) */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="border border-dashed rounded-md p-4 flex flex-col items-center justify-center min-h-[160px]">
                {imagePreview ? (
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">Kích thước gợi ý: 800x600, JPG/PNG</p>
                  </div>
                )}
                <input
                  ref={fileInputRef}
            ...
            <div className="lg:col-span-9 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Input id="course-code" value={courseCode} onChange={(e) => setCourseCode(e.target.value)} placeholder="VD: CLS-001" />
              </div>
          ...
          {/* Row 2: remaining fields + switches + actions */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center mt-2">
            <div className="lg:col-span-9 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Input id="room" value={room} onChange={(e) => setRoom(e.target.value)} placeholder="Nhập phòng" />
              </div>
              ...
              <div className="md:col-span-3">
                {/* Empty placeholder to keep grid alignment on large screens */}
              </div>
            </div>

            <div className="lg:col-span-3 flex flex-col items-end gap-3">
              <div className="text-sm text-muted-foreground">Xem trước ảnh lớp</div>
