...
const AddClass: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-start">
            ...
            <div className="col-span-1 md:col-span-3">
              {/* ... remaining top form fields (kept intact for brevity) ... */}
      ...
      {/* ... many other cards unchanged ... */}

      {/* Split into two separate cards: left = Highlights, right = IncludedFeatures */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* New IncludedFeatures component on the right */}
        <IncludedFeatures />
      </div>
